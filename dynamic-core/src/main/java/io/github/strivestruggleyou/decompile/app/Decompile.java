package io.github.strivestruggleyou.decompile.app;

import io.github.strivestruggleyou.decompile.Hex;
import io.github.strivestruggleyou.decompile.bean.Class_info;
import io.github.strivestruggleyou.decompile.bean.ExceptionTable;
import io.github.strivestruggleyou.decompile.bean.Fields_info;
import io.github.strivestruggleyou.decompile.bean.Methods_info;
import io.github.strivestruggleyou.decompile.bean.OpcodeAndOperand;
import io.github.strivestruggleyou.decompile.bean.attribute.Attribute_Code_info;
import io.github.strivestruggleyou.decompile.bean.attribute.Attribute_ConstantValue_info;
import io.github.strivestruggleyou.decompile.bean.attribute.Attribute_Deprecated_info;
import io.github.strivestruggleyou.decompile.bean.attribute.Attribute_Exceptions_info;
import io.github.strivestruggleyou.decompile.bean.attribute.Attribute_InnerClasses_info;
import io.github.strivestruggleyou.decompile.bean.attribute.Attribute_LineNumberTable_info;
import io.github.strivestruggleyou.decompile.bean.attribute.Attribute_LocalVariableTable_info;
import io.github.strivestruggleyou.decompile.bean.attribute.Attribute_Signature_info;
import io.github.strivestruggleyou.decompile.bean.attribute.Attribute_SourceFile_info;
import io.github.strivestruggleyou.decompile.bean.attribute.Attribute_Synthetic_info;
import io.github.strivestruggleyou.decompile.bean.attribute.Attribute_info;
import io.github.strivestruggleyou.decompile.bean.attribute.Inner_classes_info;
import io.github.strivestruggleyou.decompile.bean.attribute.Line_number_info;
import io.github.strivestruggleyou.decompile.bean.attribute.Local_variable_info;
import io.github.strivestruggleyou.decompile.bean.constant.Constant_Class_info;
import io.github.strivestruggleyou.decompile.bean.constant.Constant_Double_info;
import io.github.strivestruggleyou.decompile.bean.constant.Constant_Fieldref_info;
import io.github.strivestruggleyou.decompile.bean.constant.Constant_Float_info;
import io.github.strivestruggleyou.decompile.bean.constant.Constant_Integer_info;
import io.github.strivestruggleyou.decompile.bean.constant.Constant_InterfaceMethodref_info;
import io.github.strivestruggleyou.decompile.bean.constant.Constant_InvokeDynamic_info;
import io.github.strivestruggleyou.decompile.bean.constant.Constant_Long_info;
import io.github.strivestruggleyou.decompile.bean.constant.Constant_MethodHandle_info;
import io.github.strivestruggleyou.decompile.bean.constant.Constant_MethodType_info;
import io.github.strivestruggleyou.decompile.bean.constant.Constant_Methodref_info;
import io.github.strivestruggleyou.decompile.bean.constant.Constant_NameAndType_info;
import io.github.strivestruggleyou.decompile.bean.constant.Constant_String_info;
import io.github.strivestruggleyou.decompile.bean.constant.Constant_Utf8_info;
import io.github.strivestruggleyou.decompile.bean.constant.Constant_X_info;
import io.github.strivestruggleyou.decompile.core.CodeConvertor;
import io.github.strivestruggleyou.decompile.core.DataHandler;
import io.github.strivestruggleyou.decompile.core.OperandBytesJudge;
import io.github.strivestruggleyou.decompile.core.SrcCreator;
    ...
    public static String decompile(byte[] data) {
        ...
        for (int i = 0; i < cp_count - 1; i++) {
            ...
            if (type.equals("Constant_Utf8_info")) {
                Constant_Utf8_info aa = (Constant_Utf8_info) class_info.getConstant_pool_Map()
                        .get(i);
            }
            if (type.equals("Constant_Class_info")) {
                Constant_Class_info aa = (Constant_Class_info) class_info.getConstant_pool_Map()
                        .get(i);
            }
            if (type.equals("Constant_String_info")) {
                Constant_String_info aa = (Constant_String_info) class_info.getConstant_pool_Map()
                        .get(i);
            }

            if (type.equals("Constant_Fieldref_info")) {
                Constant_Fieldref_info aa = (Constant_Fieldref_info) class_info
                        .getConstant_pool_Map().get(i);
            }
            if (type.equals("Constant_Methodref_info")) {
                Constant_Methodref_info aa = (Constant_Methodref_info) class_info
                        .getConstant_pool_Map().get(i);
            }
            ...
            if (type.equals("Constant_NameAndType_info")) {
                Constant_NameAndType_info aa = (Constant_NameAndType_info) class_info
                        .getConstant_pool_Map().get(i);
            }

            if (type.equals("Constant_MethodHandle_info")) {
                Constant_MethodHandle_info aa = (Constant_MethodHandle_info) class_info
                        .getConstant_pool_Map().get(i);
            }

            if (type.equals("Constant_MethodType_info")) {
                Constant_MethodType_info aa = (Constant_MethodType_info) class_info
                        .getConstant_pool_Map().get(i);
            }

            if (type.equals("Constant_InvokeDynamic_info")) {
                Constant_InvokeDynamic_info aa = (Constant_InvokeDynamic_info) class_info
                        .getConstant_pool_Map().get(i);
            }
        }
...
//        FileCreator.createFile(fileName, src);
    ...
    public static void constant_Pool_Map_Fill(Map<Integer, Constant_X_info> constant_pool_Map,
            int i) {
        // 切分并初始化指针
        ...
        if (tag == 1) {
            ...
            constant_IntegerfaceMethodref_info
                    .setConstant_pool_info_Type("Constant_IntegerfaceMethodref_info");
            ...
            String reference_kindHexString = cutString(
                    Constant_MethodHandle_info.reference_kind_length * 2);
            int reference_kindString = Hex.hex2Integer(reference_kindHexString);
            String reference_indexHexString = cutString(
                    Constant_MethodHandle_info.reference_index_length * 2);
            ...
            String descriptor_indexHexString = cutString(
                    Constant_MethodType_info.descriptor_index_length * 2);
            ...
            int bootstrap_method_attr_index_String = Hex
                    .hex2Integer(bootstrap_method_attr_index_HexString);
            ...
            constant_InvokeDynamic_info
                    .setBootstrap_method_attr_index(bootstrap_method_attr_index_String);
    ...
    public static void attributes_info_List_Fill(List<Attribute_info> attributes_list) {
        ...
        Constant_Utf8_info typeBean = (Constant_Utf8_info) class_info.getConstant_pool_Map()
                .get(nameIndex - 1);
        ...
        if (type.equals("Code")) {
            ...
            attribute_Code_info
                    .setException_table_length(Hex.hex2Integer(exception_table_length_hexString));
            ...
            attribute_Code_info
                    .setAttributes_count(Hex.hex2Integer(attributes_count_hexString_inner));
            ...
            for (int k = 0; k < Hex.hex2Integer(attributes_count_hexString_inner); k++) {
                ...
                Constant_Utf8_info typeBean_inner = (Constant_Utf8_info) class_info
                        .getConstant_pool_Map().get(nameIndex_inner - 1);
                ...
                if (type_inner.equals("LineNumberTable")) {
                    ...
                    attribute_LineNumberTable_info
                            .setLine_number_table_List(line_number_table_List);
                    ...
                    attribute_LocalVariableTable_info
                            .setLocal_variable_table_length(
                                    Hex.hex2Integer(local_variable_table_length_hexstring));
                    // 存放 list
                    List<Local_variable_info> local_variable_table_List = new ArrayList<>();
                    for (int i = 0; i < Hex.hex2Integer(local_variable_table_length_hexstring);
                            i++) {
                    ...
                    attribute_LocalVariableTable_info
                            .setLocal_variable_table_List(local_variable_table_List);
            ...
            attribute_Exceptions_info
                    .setNumber_of_exceptions(Hex.hex2Integer(number_of_exceptions_hexString));
            ...
            attribute_ConstantValue_info
                    .setConstantvalue_index(Hex.hex2Integer(constantvalue_index_hexstring));
            ...
            attribute_InnerClasses_info
                    .setNumber_of_classes(Hex.hex2Integer(number_of_classes_hexstring));
            // 存放 list
            ...
            for (int i = 0; i < Hex.hex2Integer(number_of_classes_hexstring); i++) {
                ...
                inner_classes_info
                        .setInner_class_info_index(Hex.hex2Integer(inner_class_info_index));
                inner_classes_info
                        .setOuter_class_info_index(Hex.hex2Integer(outer_class_info_index));
    ...
    private static String cutString(int len) {
        ...
        // 初始化指针
        start_pointer = start_pointer + Decompile.len;
        return cutStr;
    }
